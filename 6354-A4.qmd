...
### a) & b) Draw the E-R diagram using draw.io. Read this website for instructions & expand to all teams in the league (Hint: add team entity)

<img src="6354-A4-P2.jpg" alt="Photo"/>
...
#### ii. Test the results using the Online SQL interpreter (https://www.db-book.com/university-lab-dir/sqljs.html)
